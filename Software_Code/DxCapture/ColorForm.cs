    ...
    partial class ColorForm : Form
    {
        ...
        private void pictureBox1_MouseClick(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                GlobalVars.ColorSelectValueR = pixelcolor.R ;
                GlobalVars.ColorSelectValueG = pixelcolor.G ;
                GlobalVars.ColorSelectValueB = pixelcolor.B ;
            }
        }

         private Color GetClickedPixel(Point point)
            {
               Bitmap bitmap = (Bitmap)ColorPic.Image;
